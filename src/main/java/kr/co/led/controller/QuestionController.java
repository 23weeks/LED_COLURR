...
public class QuestionController {
	...
	public String main(@RequestParam(value = "page", defaultValue="1") int page, Model model) { 
	 ...
	 public String readq(@RequestParam("question_idx")int question_idx,
	 ...
	 public String modifyq(@RequestParam("question_idx") int question_idx,
			 			   @RequestParam("page") int page,
	 ...
	 public String modifyq_pro(@Valid @ModelAttribute("modifyQuestionBean") QuestionBean modifyQuestionBean, BindingResult result,
	 ...
	 @PostMapping("/board_write_pro")
		public String question_pro(@Valid @ModelAttribute("writeQuestionBean") QuestionBean writeQuestionBean, BindingResult result ) {
