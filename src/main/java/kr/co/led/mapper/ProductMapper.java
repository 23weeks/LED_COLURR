...
public interface ProductMapper {
   ...
   @Select("select product_idx, product_name, product_price, product_gender, product_colortype, product_img1 "
   ...
   @Select("select product_idx, product_name, product_price, product_gender, product_colortype, product_img1, product_img2 "
